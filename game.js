...
class GameService {
    ...
    addNewPlayer = (player) => {
        ...
        this.transferNotes(1, player.id, 1500);
    ...
    transferNotes(from, to, notes) {
        ...
        fromPlayer.notes -= notes;
        toPlayer.notes += notes;

        const sum = notes;
        const fromNewSum = fromPlayer.notes;
        const toNewSum = toPlayer.notes;
